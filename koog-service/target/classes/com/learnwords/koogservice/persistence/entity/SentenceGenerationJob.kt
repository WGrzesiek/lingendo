...
/**
 * Encja reprezentująca zadanie generowania zdań.
 * 
 * Job grupuje wiele itemów (słówek) do przetworzenia.
 */
@Entity
...
class SentenceGenerationJob(
    ...
    val itemsSucceeded: Int? = null,

    @Column(name = "items_failed")
    val itemsFailed: Int? = null,
    ...
    protected constructor() : this(jobId = null)
}
