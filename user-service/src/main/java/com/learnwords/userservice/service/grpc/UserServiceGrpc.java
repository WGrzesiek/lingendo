...
public interface UserServiceGrpc {
    ...
    void checkTeacherStudentAccess(CheckTeacherStudentAccessRequest request, StreamObserver<CheckTeacherStudentAccessResponse> responseObserver);
    ...
    void checkFriendshipAccess(CheckFriendshipAccessRequest request, StreamObserver<CheckFriendshipAccessResponse> responseObserver);
    void checkUserAccess(CheckUserAccessRequest request, StreamObserver<CheckUserAccessResponse> responseObserver);
    void getAccessibleUsers(GetAccessibleUsersRequest request, StreamObserver<GetAccessibleUsersResponse> responseObserver);
