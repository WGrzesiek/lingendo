 ...
 */
export const RememberCheckBase = ({ data, interactionType, onComplete }: RememberCheckBaseProps) => {
                ...
                {!isRevealed ? (
                    <div className="text-center space-y-4">
                        <div className="p-10 border-2 border-dashed rounded-xl bg-gradient-to-br from-accent/40 to-accent/10">
                            ...
                            <Button size="lg" onClick={() => setIsRevealed(true)} className="gap-2 text-lg px-8">
                            ...
                            <div className="p-6 border rounded-xl bg-accent/30">
                                ...
                                <div className="space-y-3">
                                    {allSentences.slice(0, 2).map((sentence) => (
                                        <div key={sentence.id} className="p-4 bg-background/50 rounded-lg">
                        ...
                        <Card className="p-6 bg-gradient-to-br from-accent/50 to-background border-2">
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <Button size="lg" variant="outline" onClick={() => submit(false)}>
                                        🔁 Nie pamiętałem
                                    </Button>
                                </div>
                            </div>
