...
import { TypingStepBase } from './TypingStep';
import { RememberCheckBase } from './RememberCheckBase';
import type { InteractionType, SubmitAnswerRequest } from '../../types';
...
export const StepRenderer = ({
  ...
  switch (interactionType) {
    case 'PRESENTATION':
      return <FlashcardView data={wordContent} onComplete={(answer) => onStepComplete(answer)} />;
    ...
    case 'QUIZ_CHOICE':
      return (
        <QuizFrom data={wordContent} options={quizOptions ?? []} onComplete={onStepComplete} />
      );
